...
def generate_word_cloud(filename, color_map, max_words):
	all_content = ""
	...
	odd_fragments_and_common_terms = ["RE", "ll", "NN", "AANNDD", "TTHHEE", "VE", "CHAPTER", "YEAR", "YEARS", "FIRST", "PLATFORM", "POLICY", "POLICIES", "PEOPLE", "COUNTRY", "NATION", "NATIONAL", "WORLD", "TERM", "WASHINGTON", "FEDERAL", "GOVERNMENT", "INCLUDING", "PARTY", "PRESIDENT", "CONGRESS", "ADMINISTRATION", "WILL", "STATE", "UNITED", "STATES", "AMERICA", "AMERICAN", "AMERICANS"]
	...
	wordcloud = WordCloud(width=640, height=475, min_font_size=12, max_words=max_words, stopwords=stop_words, background_color="white", mode="RGB", relative_scaling=1, collocations=True, colormap=warm_color_map, random_state=42).generate(all_content)
...
# Democratic (Top 50): "democratic_2024_platform.pdf", "Blues", 50
# Republican (Top 50): "republican_2024_platform.pdf", "Reds", 50
generate_word_cloud("democratic_2024_platform.pdf", "Blues", 50)
generate_word_cloud("republican_2024_platform.pdf", "Reds", 50)
